...
const welcomeChannelComment = "안녕하세요 디스코드서버에 오신것을 환영합니다." // 입장 시 전송할 환영메시지의 내용을 입력하세요.
const byeChannelComment = "OUT" // 퇴장 시 전송할 메시지의 내용을 입력하세요.
...
client.on("message", (message) => {
  ...
  if (message.content == "embed") {
    ...
    if (message.member != null) {
      ...
      let embed = new Discord.MessageEmbed().setAuthor("공지 of 민구 BOT").setColor("#186de6").setFooter(`민구 BOT`).setTimestamp()
